  ...
  <div>
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="px-4 py-4 sm:pl-6 sm:pr-4">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <button class="flex w-full items-center justify-center gap-2 rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs hover:bg-brand-600 sm:w-auto">
                  <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
          ...
          <div class="border-t border-gray-100 p-4 dark:border-gray-800 sm:p-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3">
              <!-- Media item-->
              <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/[0.03] xl:pr-5">
                ...
                <div>
                  <span class="mb-1 block text-right text-sm text-gray-500 dark:text-gray-400">245 files</span>
                  <span class="block text-right text-sm text-gray-500 dark:text-gray-400">26.40 GB</span>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/[0.03] xl:pr-5">
                <div class="flex items-center gap-4">
                  <div class="flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-theme-pink-500/[0.08] text-theme-pink-500">
              ...
              <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/[0.03] xl:pr-5">
                <div class="flex items-center gap-4">
                  <div class="flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-blue-500/[0.08] text-blue-light-500">
              ...
              <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/[0.03] xl:pr-5">
                <div class="flex items-center gap-4">
                  <div class="flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-orange-500/[0.08] text-orange-500">
              ...
              <div class="flex items-center justify-between rounded-2xl border border-gray-100 bg-white py-4 pl-4 pr-4 dark:border-gray-800 dark:bg-white/[0.03] xl:pr-5">
                <div class="flex items-center gap-4">
                  <div class="flex h-[52px] w-[52px] items-center justify-center rounded-xl bg-theme-purple-500/[0.08] text-theme-purple-500">
                    <svg class="fill-current" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
      ...
      <div class="col-span-12 xl:col-span-4">
        <!-- ====== Chart Sixteen Start -->
        <div class="rounded-2xl border border-gray-200 bg-white px-4 pt-6 pb-6 sm:px-6 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <div>
            <div id="chartSixteen" class="flex justify-center mx-auto chartDarkStyle" style="min-height: 329px">
              <div id="apexchartsorqcn362" class="apexcharts-canvas apexchartsorqcn362 apexcharts-theme-" style="width: 400px; height: 329px">
                <svg
                  id="SvgjsSvg1042"
                  width="400"
                  height="329"
                ...
                >
                  <foreignObject x="0" y="0" width="400" height="329">
                    <div xmlns="http://www.w3.org/1999/xhtml" style="position: relative; height: 100%; width: 100%">
                      <div class="apexcharts-legend apexcharts-align-left apx-legend-position-bottom" style="right: 0px; position: absolute; left: 0px; top: 302.333px; max-height: 166.667px">
                        <div class="apexcharts-legend-series" rel="1" seriesname="Downloads" data:collapsed="false" style="margin: 6px 10px">
                          <span class="apexcharts-legend-marker" rel="1" data:collapsed="false" style="height: 10px; width: 10px; left: 0px; top: 0px">
                            <svg
                              id="SvgjsSvg1045"
                              width="100%"
                              height="100%"
                            ...
                            >
                              <defs id="SvgjsDefs1046">
                                <clipPath id="gridRectMaskorqcn362">
                                  <rect
                                    id="SvgjsRect1057"
                                    width="400"
                                ...
                                <clipPath id="gridRectBarMaskorqcn362">
                                  <rect
                                    id="SvgjsRect1058"
                                    width="408"
                                ...
                                <clipPath id="gridRectMarkerMaskorqcn362">
                                  <rect
                                    id="SvgjsRect1059"
                                    width="400"
                                    height="293.33333333333337"
                                ...
                                <clipPath id="forecastMaskorqcn362"></clipPath>
                                <clipPath id="nonForecastMaskorqcn362"></clipPath>
                              </defs>
                              <path
                                id="SvgjsPath1047"
                                d="M 0, 0 
           ...
           a 5,5 0 1,0 -10,0"
                          ...
                          <span
                            ...
                            rel="1"
                            i="0"
                            data:default-text="Downloads"
                            data:collapsed="false"
                            style="color: rgb(55, 61, 63); font-size: 14px; font-weight: 400; font-family: Outfit"
                          >
                            Downloads
                          </span>
                        </div>
                        <div class="apexcharts-legend-series" rel="2" seriesname="Apps" data:collapsed="false" style="margin: 6px 10px">
                          <span class="apexcharts-legend-marker" rel="2" data:collapsed="false" style="height: 10px; width: 10px; left: 0px; top: 0px">
                            <svg
                              id="SvgjsSvg1048"
                              width="100%"
                              height="100%"
           ...
           a 5,5 0 1,0 -10,0"
                        ...
                        <div class="apexcharts-legend-series" rel="3" seriesname="Documents" data:collapsed="false" style="margin: 6px 10px">
                          <span class="apexcharts-legend-marker" rel="3" data:collapsed="false" style="height: 10px; width: 10px; left: 0px; top: 0px">
                            <svg
                              id="SvgjsSvg1051"
                              width="100%"
                              height="100%"
           ...
           a 5,5 0 1,0 -10,0"
                        ...
                        <div class="apexcharts-legend-series" rel="4" seriesname="Media" data:collapsed="false" style="margin: 6px 10px">
                          <span class="apexcharts-legend-marker" rel="4" data:collapsed="false" style="height: 10px; width: 10px; left: 0px; top: 0px">
                            <svg
                              id="SvgjsSvg1054"
                              width="100%"
                              height="100%"
           ...
           a 5,5 0 1,0 -10,0"
                  ...
                  <g id="SvgjsG1044" class="apexcharts-inner apexcharts-graphical" transform="translate(0, 0)">
                    <defs id="SvgjsDefs1043"></defs>
                    <g id="SvgjsG1062" class="apexcharts-pie">
                      <g id="SvgjsG1063" transform="translate(0, 0) scale(1)">
                        <circle id="SvgjsCircle1064" r="87.80813008130085" cx="200" cy="146.66666666666669" fill="transparent"></circle>
                        <g id="SvgjsG1065" class="apexcharts-slices">
                          <g id="SvgjsG1066" class="apexcharts-series apexcharts-pie-series" seriesName="Downloads" rel="1" data:realIndex="0">
                            <path
                              id="SvgjsPath1067"
                          ...
                          <g id="SvgjsG1068" class="apexcharts-series apexcharts-pie-series" seriesName="Apps" rel="2" data:realIndex="1">
                            <path
                              id="SvgjsPath1069"
                          ...
                          <g id="SvgjsG1070" class="apexcharts-series apexcharts-pie-series" seriesName="Documents" rel="3" data:realIndex="2">
                            <path
                              id="SvgjsPath1071"
                          ...
                          <g id="SvgjsG1072" class="apexcharts-series apexcharts-pie-series" seriesName="Media" rel="4" data:realIndex="3">
                            <path
                              id="SvgjsPath1073"
                      ...
                      <g id="SvgjsG1060" class="apexcharts-datalabels-group" transform="translate(0, 0) scale(1)">
                        <text
                          id="SvgjsText1074"
                    ...
                    <line id="SvgjsLine1076" x1="0" y1="0" x2="400" y2="0" stroke="#b6b6b6" stroke-dasharray="0" stroke-width="1" stroke-linecap="butt" class="apexcharts-ycrosshairs"></line>
                    <line id="SvgjsLine1077" x1="0" y1="0" x2="400" y2="0" stroke-dasharray="0" stroke-width="0" stroke-linecap="butt" class="apexcharts-ycrosshairs-hidden"></line>
                  </g>
                  <g id="SvgjsG1061" class="apexcharts-datalabels-group" transform="translate(0, 0) scale(1)"></g>
                </svg>
              </div>
            </div>
          </div>
      ...
      <div class="col-span-12">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
          <div class="mb-4 flex items-center justify-between px-6">
            ...
            <a href="#" class="inline-flex items-center gap-2 text-gray-500 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-500">
              View All
              <svg class="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill-rule="evenodd"
            ...
            <div class="min-w-[1026px]">
              ...
              <div class="grid grid-cols-11 border-t border-gray-200 px-6 py-3 dark:border-gray-800">
                <div class="col-span-3 flex items-center">
                  <p class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">File Name</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">Category</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">Size</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm font-medium text-gray-500 dark:text-gray-400">Date Modified</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <p class="w-full text-center text-theme-sm font-medium text-gray-500 dark:text-gray-400">Action</p>
                </div>
              </div>
              <!-- table header end -->
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                <div class="col-span-3 flex items-center">
                  <div class="flex w-full items-center gap-2 text-sm text-gray-700 dark:text-gray-400">
                    <div>
                      <img src="https://demo.tailadmin.com/src/images/icons/file-image.svg" alt="icon" class="dark:hidden" />
                      <img src="https://demo.tailadmin.com/src/images/icons/file-image.svg" alt="icon" class="hidden dark:block" />
                    </div>
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">12 Jan, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">19 Feb, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                <div class="col-span-3 flex items-center">
                  <div class="flex w-full items-center gap-2 text-sm text-gray-700 dark:text-gray-400">
                    <div>
                      <img src="https://demo.tailadmin.com/src/images/icons/file-image.svg" alt="icon" class="dark:hidden" />
                      <img src="https://demo.tailadmin.com/src/images/icons/file-image-dark.svg" alt="icon" class="hidden dark:block" />
                    </div>
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">15 Mar, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">29 Apr, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">20 May, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">17 Jun, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
              ...
              <div class="grid grid-cols-11 border-t border-gray-100 px-6 py-[18px] dark:border-gray-800">
                ...
                <div class="col-span-2 flex items-center">
                  <p class="text-theme-sm text-gray-700 dark:text-gray-400">27 Jul, 2027</p>
                </div>
                <div class="col-span-2 flex items-center">
                  <div class="flex w-full items-center justify-center gap-2">
                    <button class="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500">
