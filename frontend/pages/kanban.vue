<template>
  <div>
    ...
    <div x-data="{selectedTaskGroup: 'All'}" class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <!-- Task wrapper Start -->
      <div class="mt-7 grid grid-cols-1 border-t border-gray-200 dark:border-gray-800 sm:mt-0 sm:grid-cols-2 xl:grid-cols-3">
        <!-- To do list -->
        <div class="swim-lane flex flex-col gap-5 p-4 xl:p-6">
          <div class="mb-1 flex items-center justify-between">
            <h3 class="flex items-center gap-3 text-base font-medium text-gray-800 dark:text-white/90">
              To Do
              <span class="inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-theme-xs font-medium text-gray-700 dark:bg-white/[0.03] dark:text-white/80">3</span>
            </h3>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              ...
              <div class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="@/assets/images/product-01.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Solve the Dribbble prioritisation issue with the team</h4>
                ...
                <span class="mt-3 inline-flex rounded-full bg-brand-50 px-2 py-0.5 text-theme-xs font-medium text-brand-500 dark:bg-brand-500/15 dark:text-brand-400">Marketing</span>
              </div>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Change license and remove products</h4>
                ...
                <span class="mt-3 inline-flex rounded-full bg-gray-100 px-2 py-0.5 text-theme-xs font-medium text-gray-700 dark:bg-white/[0.03] dark:text-white/80">Dev</span>
              </div>
        ...
        <div class="swim-lane flex flex-col gap-5 border-x border-gray-200 p-4 dark:border-gray-800 xl:p-6">
          <div class="mb-1 flex items-center justify-between">
            <h3 class="flex items-center gap-3 text-base font-medium text-gray-800 dark:text-white/90">
              In Progress
              <span class="inline-flex rounded-full bg-warning-50 px-2 py-0.5 text-theme-xs font-medium text-warning-700 dark:bg-warning-500/15 dark:text-orange-400">5</span>
            </h3>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Work In Progress (WIP) Dashboard</h4>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Kanban Flow Manager</h4>
                ...
                <span class="mt-3 inline-flex rounded-full bg-success-50 px-2 py-0.5 text-theme-xs font-medium text-success-700 dark:bg-success-500/15 dark:text-success-500">Template</span>
              </div>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div>
              <h4 class="mb-2 text-base text-gray-800 dark:text-white/90">Product Update - Q4 2024</h4>

              <p class="text-sm text-gray-500 dark:text-gray-400">Dedicated form for a category of users that will perform actions.</p>

              <div class="my-4">
                <img src="@/assets/images/product-01.jpg" alt="task" class="overflow-hidden rounded-xl border-[0.5px] border-gray-200 dark:border-gray-800" />
              </div>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Make figbot send comment when ticket is auto-moved back to inbox</h4>
        ...
        <div class="swim-lane flex flex-col gap-5 p-4 xl:p-6">
          <div class="mb-1 flex items-center justify-between">
            <h3 class="flex items-center gap-3 text-base font-medium text-gray-800 dark:text-white/90">
              Completed
              <span class="inline-flex rounded-full bg-success-50 px-2 py-0.5 text-theme-xs font-medium text-success-700 dark:bg-success-500/15 dark:text-success-500">4</span>
            </h3>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Manage internal feedback</h4>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Do some projects on React Native with Flutter</h4>
                ...
                <span class="mt-3 inline-flex rounded-full bg-orange-400/10 px-2 py-0.5 text-theme-xs font-medium text-orange-400">Development</span>
              </div>
          ...
          <div draggable="true" class="task rounded-xl border border-gray-200 bg-white p-5 shadow-theme-sm dark:border-gray-800 dark:bg-white/5">
            <div class="flex items-start justify-between gap-6">
              <div>
                <h4 class="mb-5 text-base text-gray-800 dark:text-white/90">Design marketing assets</h4>
